...
const Contact = () => {
    ...
    return (
        ...
        ${i18n.language === 'en' ? styles.english : styles.farsi}`}>
            ...
            <div className={styles.contactWayContainer}>
                <a href="mailto:ftm.ngh.2001@gmail.com" target="-blank">
                    <div>
                ...
                <a href="tel:09387491560" target="-blank">
                    <div>
                ...
                <a href="https://www.linkedin.com/in/fatemeh-ngh-1375a4237/" target="-blank">
                    <div>
                ...
                <a href="https://t.me/Fatemeh_ngh_2001" target="-blank">
                    <div>
                ...
                <a href="https://stackoverflow.com/users/17941025/fatemeh?tab=profile" target="-blank">
                    <div>
                ...
                <a href="https://github.com/fatemeh-ngh" target="-blank">
                    <div>
